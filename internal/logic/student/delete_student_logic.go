...
func (l *DeleteStudentLogic) DeleteStudent(in *example.UUIDsReq) (*example.BaseResp, error) {
	_, err := l.svcCtx.DB.Student.Delete().Where(student.IDIn(uuidx.ParseUUIDSlice(in.Ids)...)).Exec(l.ctx)
