...
func init() {
	...
	studentMixinHooks1 := studentMixin[1].Hooks()
	student.Hooks[0] = studentMixinHooks1[0]
	studentMixinInters1 := studentMixin[1].Interceptors()
	student.Interceptors[0] = studentMixinInters1[0]
