...
// set field if value's pointer is not nil.
func (s *StudentUpdate) SetNotNilDeletedAt(value *time.Time) *StudentUpdate {
	if value != nil {
...
// set field if value's pointer is not nil.
func (s *StudentUpdateOne) SetNotNilDeletedAt(value *time.Time) *StudentUpdateOne {
	if value != nil {
		return s.SetDeletedAt(*value)
	}
	return s
...
// set field if value's pointer is not nil.
func (s *StudentCreate) SetNotNilDeletedAt(value *time.Time) *StudentCreate {
	if value != nil {
		return s.SetDeletedAt(*value)
	}
	return s
